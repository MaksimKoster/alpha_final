...
class Matcher:
    ...
    Matcher steps:
        - Read, analyze data
        - Feature selection via lightautoml2
        ...
        - After receiving the result, the result should be validated using :func:`~lightautoml2.addons.hypex.matcher.Matcher.validate_result`
