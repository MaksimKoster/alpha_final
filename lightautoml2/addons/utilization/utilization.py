...
class TimeUtilization:
    """Class that helps to utilize given time to :class:`~lightautoml2.automl.presets.base.AutoMLPreset`.
    ...
    Note:
        ...
        called like usual :class:`~lightautoml2.automl.base.AutoML` class.
