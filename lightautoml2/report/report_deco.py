...
from lightautoml2.addons.uplift import metrics as uplift_metrics
from lightautoml2.addons.uplift.metalearners import TLearner
from lightautoml2.addons.uplift.metalearners import XLearner
from lightautoml2.addons.uplift.utils import _get_treatment_role
from lightautoml2.dataset import roles as laml_roles
...
class ReportDeco:
    """
    Decorator to wrap :class:`~lightautoml2.automl.base.AutoML` class to generate html report on ``fit_predict`` and ``predict``.
...
class ReportDecoUtilized(ReportDeco):
    """
    Special report wrapper for :class:`~lightautoml2.automl.presets.tabular_presets.TabularUtilizedAutoML`.
    Usage case is the same as main
    :class:`~lightautoml2.report.report_deco.ReportDeco` class.
    It generates same report as :class:`~lightautoml2.report.report_deco.ReportDeco` ,
...
class ReportDecoWhitebox(ReportDeco):
    """
    Special report wrapper for :class:`~lightautoml2.automl.presets.whitebox_presets.WhiteBoxPreset`.
    Usage case is the same as main
    :class:`~lightautoml2.report.report_deco.ReportDeco` class.
    It generates same report as :class:`~lightautoml2.report.report_deco.ReportDeco` ,
    ...
    Difference:
        ...
        - :class:`~lightautoml2.automl.presets.whitebox_presets.WhiteBoxPreset`
...
class ReportDecoNLP(ReportDeco):
    """
    Special report wrapper for :class:`~lightautoml2.automl.presets.text_presets.TabularNLPAutoML`.
    Usage case is the same as main
    :class:`~lightautoml2.report.report_deco.ReportDeco` class.
    It generates same report as :class:`~lightautoml2.report.report_deco.ReportDeco` ,
