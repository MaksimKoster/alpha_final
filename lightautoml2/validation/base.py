...
from lightautoml2.dataset.base import LAMLDataset
from lightautoml2.pipelines.features.base import FeaturesPipeline
...
class CustomIterator(TrainValidIterator):
    ...
    def convert_to_holdout_iterator(self) -> "HoldoutIterator":
        ...
        Use first train/valid split for :class:`~lightautoml2.validation.base.HoldoutIterator` creation.
