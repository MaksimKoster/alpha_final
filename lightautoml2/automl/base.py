...
class AutoML:
    ...
    Args:
        reader: Instance of Reader class object that
            creates :class:`~lightautoml2.dataset.base.LAMLDataset`
            from input data.
        levels: List of list
            of :class:`~lightautoml2.pipelines.ml..base.MLPipelines`.
        timer: Timer instance of
            :class:`~lightautoml2.utils.timer.PipelineTimer`.
            Default - unlimited timer.
        blender: Instance of Blender.
            Default - :class:`~lightautoml2.automl.blend.BestModelSelector`.
    ...
    def _initialize(
        ...
        Args:
            reader: Instance of Reader class object that
                creates :class:`~lightautoml2.dataset.base.LAMLDataset` from input data.
            levels: List of list of :class:`~lightautoml2.pipelines.ml..base.MLPipelines`.
            timer: Timer instance of :class:`~lightautoml2.utils.timer.PipelineTimer`.
                Default - unlimited timer.
            blender: Instance of Blender. Default - :class:`~lightautoml2.automl.blend.BestModelSelector`.
            skip_conn: True if we should pass first level
                input features to next levels.
