...
class Reader:
    ...
    :class:`~lightautoml2.dataset.base.LAMLDataset` from raw data.
...
class PandasToPandasReader(Reader):
    ...
    Reader to convert :class:`~pandas.DataFrame` to AutoML's :class:`~lightautoml2.dataset.np_pd_dataset.PandasDataset`.
    Stages:
...
class DictToPandasSeqReader(PandasToPandasReader):
    """Reader with sequential support to convert :class:`~pandas.DataFrame` to AutoML's :class:`~lightautoml2.dataset.np_pd_dataset.PandasDataset`.
